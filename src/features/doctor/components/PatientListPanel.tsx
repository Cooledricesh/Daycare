...
interface DoctorPatientRowProps {
  ...
  isSelected: boolean;
  streak: number;
  onSelect: (patient: WaitingPatient) => void;
}

const DoctorPatientRow = memo(function DoctorPatientRow({
  patient,
  isSelected,
  streak,
  onSelect,
}: DoctorPatientRowProps) {
...
DoctorPatientRow.displayName = 'DoctorPatientRow';
...
export function PatientListPanel({
  ...
  const handleSelectPatient = useCallback(
    (patient: WaitingPatient) => onSelectPatient(patient),
    [onSelectPatient],
  );
